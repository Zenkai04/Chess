...
Queen::Queen(int team, sf::Vector2i position) : Piece(PieceType::QueenPiece, position, 1, team) {
...
bool Queen::canMoveToPosition(sf::Vector2i testPosition, Piece*** pieces) const {
...
void Queen::updateReachablePositions(Piece*** pieces, ReachableCase** reachableCases, Player* playingPlayer) {
	reachablePositions = computeReachablePositions(pieces, reachableCases, playingPlayer);
}

std::vector<sf::Vector2i> Queen::computeReachablePositions(Piece*** pieces, ReachableCase** reachableCases, Player* playingPlayer) {
...
bool Queen::isInMap(int x, int y, int width, int height) {
